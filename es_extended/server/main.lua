...
AddEventHandler('esx:giveInventoryItem', function(target, type, itemName, itemCount)
	...
	local logs = "https://discord.com/api/webhooks/936219131957612626/u8mFUuH9h72JVWWmJ5c3zs7XEWWAZG6V5qKZwytDw39uu3Ue-5Vxxh-nwDnyC-rJoTmq"
	...
	if type == 'item_standard' then
	    ...
	    if itemCount > 0 and sourceItem.count >= itemCount then
	        ...
	        if targetItem.limit ~= -1 and (targetItem.count + itemCount) > targetItem.limit then
				...
				local communityname = "Wendigo Roleplay"
				local communitylogo = "https://imgur.com/CzxrAw8.png"
				...
				local connect = {
					{
						["color"] = "8663711",
						["title"] = "Player gives item to other player!",
						["description"] = "Player: **"..sourceXPlayer.name.."\nItem: **"..itemName.."**\nTarget: **"..targetXPlayer.name.."**\nJumlah: **"..itemCount.."\nIP: **"..ip.."\n SteamHex: **"..steamhex.."**",
						["footer"] = {
							["text"] = communityname,
				...
				PerformHttpRequest(logs, function(err, text, headers) end, 'POST', json.encode({username = "Wendigo Logger", embeds = connect}), {['Content-Type'] = 'application/json'})
	...
	elseif type == 'item_account' then
		...
		if itemCount > 0 and sourceXPlayer.getAccount(itemName).money >= itemCount then
			...
			local connect = {
				{
					["color"] = "8663711",
					["title"] = "Player gives money to other player!",
					["description"] = "Player: **"..sourceXPlayer.name.."\nItem: **"..itemName.."**\nTarget: **"..targetXPlayer.name.."**\nJumlah: **"..itemCount.."\nIP: **"..ip.."\n SteamHex: **"..steamhex.."**",
					["footer"] = {
						["text"] = communityname,
						["icon_url"] = communitylogo,
	...
	elseif type == 'item_weapon' then
		...
		if not targetXPlayer.hasWeapon(itemName) then
			...
			local connect = {
				{
					["color"] = "8663711",
					["title"] = "Player gives weapon to other player!",
					["description"] = "Player: **"..sourceXPlayer.name.."\nItem: **"..weaponLabel.."**\nTarget: **"..targetXPlayer.name.."**\nJumlah: **"..itemCount.."\nIP: **"..ip.."\n SteamHex: **"..steamhex.."**",
					["footer"] = {
						["text"] = communityname,
						["icon_url"] = communitylogo,
